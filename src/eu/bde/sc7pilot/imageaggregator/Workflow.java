...
//			DownloadService downloadService = new DownloadService(imageData.getUsername(), imageData.getPassword());
			...
			//making it real
		    System.out.println("Going to sleep for 3 secs");
			Thread.sleep(3000);	
...
//			IAutils.infoImages(images);
			...
			System.out.println("\tReading from properties.txt:");
		    ...
		    String img1name = lines.get(1);
		    String img2name = lines.get(2);
		    String img3name = lines.get(3);
		    String img4name = lines.get(4);
		    ...
		    Geometry selectedArea = wkt.read(lines.get(0));
		    
		    // Downloading images
		    subject.onNext("Downloading images...@@@" + img1name + "@@@" + img2name);
		    System.out.println("Going to sleep for 7 secs");
			Thread.sleep(7000);	
			System.out.println("I AM AWAKE!");
...
//			client.saveChanges(changesToStore);
			...
			img1JSON.put("extent", lines.get(5));
			img2JSON.put("url", qlook2File.getAbsolutePath());
			img2JSON.put("extent", lines.get(6));
